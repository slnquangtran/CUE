...
class YoutubeUrlExtractor(QMainWindow):
    ...
    def setup_ui(self):
        ...
        channel_group.setStyleSheet("""
            QGroupBox {
                background-color: rgba(255, 255, 255, 40); /* Màu trắng mờ nhẹ */
                border: 1px solid rgba(255, 255, 255, 100); /* Viền trắng mảnh giúp box sắc nét hơn */
                border-radius: 15px; /* Bo góc tròn trịa giống ảnh image_aeeedd.jpg */
                margin-top: 15px; /* Tạo khoảng trống cho tiêu đề phía trên */
                color: black;
                font-weight: bold;
            }
            QGroupBox::title {
...
# Thêm lề để nội dung bên trong không dính sát vào viền box
        ...
        extract_group.setStyleSheet("""
            QGroupBox {
                ...
                border-radius: 15px; /* Bo góc tròn trịa giống ảnh image_aeeedd.jpg */
                margin-top: 15px; /* Tạo khoảng trống cho tiêu đề phía trên */
                color: black; /* Chữ tiêu đề GroupBox màu trắng */
                font-weight: bold;
            }
            QGroupBox::title {
                subcontrol-origin: margin;
        ...
        self.extract_button.setStyleSheet("background-color: black; color: white")
